...
public class DetailActivity extends AppCompatActivity {
    ...
    private String[] nopetang = {"Doa yang dibaca di pagi hari",
            "1",
            "2",
            "3",
            "4",
    ...
    private String[] idsholat = {"Istighfar",
    "dzikir1",
    "dzikir2",
    "dzikir3",
    "dzikir4",
    ...
    "12",
    "13"};
    private String[] judulsholat = {"أَسْتَغْفِرُ اللهَ",
    ...
    "بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ\n" +
            "\n" +
            "قُلْ هُوَ اللَّهُ أَحَد(١)ٌ اللَّهُ الصَّمَد(٢)ُ لَمْ يَلِدْ وَلَمْ يُولَد(٣)ْ وَلَمْ يَكُن لَّهُ كُفُوًا أَحَدٌ(٤)",
    "بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ\n" +
            "\n" +
            "قُلْ أَعُوذُ بِرَبِّ الْفَلَقِ(١) مِن شَرِّ مَا خَلَق(٢)َ وَمِن شَرِّ غَاسِقٍ إِذَا وَقَبَ(٣) وَمِن شَرِّ النَّفَّاثَاتِ فِي الْعُقَد(٤)ِ  وَمِن شَرِّ حَاسِدٍ إِذَا حَسَد(٥)َ",
    "بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ\n" +
            "\n" +
            "قُلْ أَعُوذُ بِرَبِّ النَّاس(١)ِ مَلِكِ النَّاسِ(٢) إِلَهِ النَّاسِ(٣) مِن شَرِّ الْوَسْوَاسِ الْخَنَّاسِ(٤) الَّذِي يُوَسْوِسُ فِي صُدُورِ النَّاس(٥)ِ مِنَ الْجِنَّةِ وَ النَّاس(٦)ِ",
    "اَللَّهُمَّ إِنِّيْ أَسْأَلُكَ عِلْمًا نَافِعًا، وَرِزْقًا طَيِّبًا، وَعَمَلاً مُتَقَبَّلاً"};
    private String[] subjudulsholat = {"“Aku minta ampun kepada Allah,”(Dibaca 3x)",
    ...
    "“Tiada Rabb yang berhak disembah selain Allah Yang Maha Esa, tidak ada sekutu bagi-Nya. Bagi-Nya puji dan bagi-Nya kerajaan. Dia Maha Kuasa atas segala sesuatu. Ya Allah, tidak ada yang mencegah apa yang Engkau berikan dan tidak ada yang memberi apa yang Engkau cegah. Tidak berguna kekayaan dan kemuliaan itu bagi pemiliknya (selain iman dan amal shalihnya yang menyelamatkan dari siksaan). Hanya dari-Mu kekayaan dan kemuliaan.”(Dibaca 1x)",
    "“Tiada Rabb (yang berhak disembah) kecuali Allah, Yang Maha Esa, tidak ada sekutu bagi-Nya. Bagi-Nya kerajaan dan pujaan. Dia Mahakuasa atas segala sesuatu. Tidak ada daya dan kekuatan kecuali (dengan pertolongan) Allah. Tiada Rabb (yang hak disembah) kecuali Allah. Kami tidak menyembah kecuali kepada-Nya. Bagi-Nya nikmat, anugerah dan pujaan yang baik. Tiada Rabb (yang hak disembah) kecuali Allah, dengan memurnikan ibadah kepadaNya, sekalipun orang-orang kafir sama benci.”(Dibaca 1x)",
    "“Maha Suci Allah”(Dibaca 33x)",
    "“Segala Puji Bagi Allah”(Dibaca 33x)",
    "“Allah Maha Besar”(Dibaca 33x)",
    "“Tidak ada Rabb (yang berhak disembah) kecuali Allah Yang Maha Esa, tidak ada sekutu bagi-Nya. Bagi-Nya kerajaan. Bagi-Nya pujaan. Dia-lah Yang Mahakuasa atas segala sesuatu.”(Dibaca 1x)",
    "“Allah, tidak ada ilah (yang berhak disembah) melainkan Dia, yang hidup kekal lagi terus menerus mengurus (makhluk-Nya). Dia tidak mengantuk dan tidak tidur. Kepunyaan-Nya apa yang di langit dan di bumi. Tiada yang dapat memberi syafa’at di sisi-Nya tanpa seizin-Nya. Dia mengetahui apa-apa yang di hadapan mereka dan di belakang mereka. Mereka tidak mengetahui apa-apa dari ilmu Allah melainkan apa yang dikehendaki-Nya. Kursi Allah meliputi langit dan bumi. Dia tidak merasa berat memelihara keduanya. Dan Dia Maha Tinggi lagi Maha besar.”(Dibaca 1x)",
    "“Dengan menyebut nama Allah Yang Maha Pengasih lagi Maha Penyayang. Katakanlah: Dialah Allah, Yang Maha Esa. Allah adalah ilah yang bergantung kepada-Nya segala urusan. Dia tidak beranak dan tiada pula diperanakkan, dan tidak ada seorang pun yang setara dengan Dia.”(Dibaca 3x)",
    "“Dengan menyebut nama Allah Yang Maha Pengasih lagi Maha Penyayang. Katakanlah: Aku berlindung kepada Rabb yang menguasai Shubuh, dari kejahatan makhluk-Nya, dan dari kejahatan malam apabila telah gelap gulita, dan dari kejahatan-kejahatan wanita tukang sihir yang menghembus pada buhul-buhul, dan dari kejahatan orang yang dengki apabila ia dengki.”(Dibaca 3x)",
    "“Dengan menyebut nama Allah Yang Maha Pengasih lagi Maha Penyayang. Katakanlah: Aku berlindung kepada Rabb manusia. Raja manusia. Sembahan manusia, dari kejahatan (bisikan) syaitan yang biasa bersembunyi, yang membisikkan (kejahatan) ke dalam dada manusia, dari jin dan manusia.”(Dibaca 3x)",
    ...
    private void setDataSholat(){
        for (String idsholat : idsholat){
            arrayList.add(new ModelDzikir(idsholat, nosholat[count], judulsholat[count], subjudulsholat[count]));
            count++;
        }
    }
}
